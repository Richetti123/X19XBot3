...
if (command == 'play') {	
try {
const dataRE = await fetch(`https://api-rin-tohsaka.vercel.app/download/ytmp3?url=${yt_play[0].url}`);
...
if (command == 'play2') {
try {
const dataRE = await fetch(`https://api-rin-tohsaka.vercel.app/download/ytmp4?url=${yt_play[0].url}`);
const dataRET = await dataRE.json();
console.log(dataRET)
